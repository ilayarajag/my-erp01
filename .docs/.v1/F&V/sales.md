...
![Sales Screen](../ImagesF&V/Sales.png)

**Sales opening DC screen**

![Sales Screen](../ImagesF&V/Sales1.png)

**Sales export pending screen**

![Sales Screen](../ImagesF&V/Sales2.png)

**Sales mail export screen**

![Sales Screen](../ImagesF&V/Sales3.png)

**Sales DC closse screen**

![Sales Screen](../ImagesF&V/salesdcclose.png)

**Sales save screen**

![Sales Screen](../ImagesF&V/Sales4.png)
...
1.  List the grid product items based on DC List showing on the screen
2.  Picked by default `0`
3.  `S_MSUid` - `0`
4.  Item wise - `Expiry date to be calculated based on manufacture date and Expiry Period`
5.  Tray Entry to be there
6.  Tray ledger logic to be done
7.  Stock Ledger logic to be done
8.  `StockLedger` table below should affect
