...
![Shrinkage Screen](../ImagesFMCG/Shrinkage.png)

**Shrinkage entry screen**

![Shrinkage Screen](../ImagesFMCG/Shrinkage1.png)

**Shrinkage Save screen**

![Shrinkage Screen](../ImagesFMCG/Shrinkage2.png)

## Logics

1. When product enter, need to fill reason
2. WH less=0, D&E to be filled (atleast any one) `Qty= WHless+ D&E `
