...
![PO Approval](../ImagesFMCG/purchase%20order%20approval.png)

**PO approval entry screen**
![PO Approval](../ImagesFMCG/purchase%20order%20approval%201.png)

**PO approval save screen**
![PO Approval](../ImagesFMCG/purchase%20order%20approval%202.png)

## LOGICs

1. List out all the POs that is open for approval pending.
2. Can view the PO details and the items in the PO.
3. When approval user can edit Qty - need Post this `POD_Qty`
...
8. by default PO_Status is `2` - grn completed po_status = 3 -grn completed po_status = 2 - unapproval
