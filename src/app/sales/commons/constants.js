...
const SPLCOUPONISSUE = {
  NAME: "SplCoupon_Issue",
  COLUMNS: {
    CODE: "Code",
    EDATE: "Edate",
    DPER: "dper",
...
const YEAR_SALES = {
  ...
  COLUMNS: {
    ...
    COUNT_RET: "countret",
    CASH_RET: "cashret",
    CREDIT_RET: "creditret",
    PCASH_RET: "pcashret",
    PCREDIT_RET: "pcreditret",
    ORDER_RET: "orderret",
    LOCAL_CASH: "localcash",
    LOCAL_CARD: "localcard",
    S_ROUND_OFF: "sroundoff",
    S_DISCOUNT: "sdiscount",
    BRANCH_AMOUNT: "branchamount",
    P_DISCOUNT: "pdiscount",
    P_ROUND_OFF: "proundoff",
    S_VAT: "svat",
    P_VAT: "pvat",
    CASH_GIFT_CARD: "cashgiftcard",
    CID: "cid",
    OTHER_AMOUNT: "otheramt",
    OFF_AMOUNT: "offamt",
    S_ROUND_OFF_1: "sroundoff1",
    S_DISCOUNT_1: "sdiscount1",
    OFF_AMOUNT_1: "offamt1",
    STATUS: "status",
    ONLINE: "online",
    CB_AMT: "cbamt"
  }
...
const COUNTER_SALES = {
  ...
  COLUMNS: {
    ...
    U_REMIT: "uremit",
    OUTLET_ID: "outlet_id",
    COUNTER_USER_NAME : "counter_user_name",
    USER_MOBILE : "user_mobile"
  }
};
const SPL_COUPON_DETAIL = {
  NAME: "splCoupon_Detail",
  COLUMNS: {
    ENTRY_DATE: "Entry_date",
    CNT: "cnt",
    BNO: "bno",
...
const ITEM_DETAILS = {
  ...
  COLUMNS: {
    ...
    ORDER_QTY: "orderqty",
    CASH_PURCHASE_QTY: "cashpurqty",
    CREDIT_PURCHASE_QTY: "creditpurqty",
    WASTE_QTY: "wasteqty",
    PHY_QTY: "phyqty",
    PARENT_CODE: "parent_code",
    P_VALUE: "pvalue",
    ...
    W_VALUE: "wvalue",
    PRET_CASH: "pretcash",
    PRET_CREDIT: "pretcredit",
    S_RET_CASH: "sretcash",
    S_RET_CREDIT: "sretcredit",
    S_RET_ORDER: "sretorder",
    ISS_QTY: "issqty",
    STK_RET: "stkret",
    STK_IN: "stkin",
    CID: "cid",
...
const COUNTER_CART_TEMP = {
  NAME: "counter_cart_temp",   // ✅ no space
  COLUMNS: {
    ID: "id",
    PROD_ID: "prod_id",
    QTY: "qty",
...
const OUT_BILL_MASTER = {
  NAME: "out_bill_master",
  COLUMNS: {
    ID: "id",
    LOC_ID: "locid",
    BILL_NO: "billno",
    ...
    IOFF_AMT: "ioffamt",
    WHATSAPP: "whatsapp",
    CUST_COUPON_CODE: "cust_couponcode",
    CUST_COUPON_AMT: "cust_couponamt",
    LOCNAME: "locname",
    USERNAME: "username",
    MOBILENO: "mobileno",
...
const OUT_BILL_DETAIL = {
  NAME: "out_bill_detail",
  COLUMNS: {
    ID: "id",
    LOC_ID: "locid",
    BILL_NO: "billno",
    ...
    BARCODE: "barcode",
    LOYALTY_AMT: "loyalty_amt",
    IDIS_OFF_AMT: "idisoff_amt",
    I_COUP_AMT: "icoup_amt",
    COUP_AMT: "coup_amt",
    SCH_AMT: "sch_amt",
    OFF_AMT: "off_amt",
    DIS_AMT: "dis_amt",
    ...
    PRODNAME: "prodname",
    SUBCTGID: "subctgid",
    SUBCTGINAME: "subctginame",
    MAINCTGID: "mainctgid",
    MAINCTGINAME: "mainctginame",
    BRANDID: "brandid",
    BRANDNAME: "brandname",
    MERCHANDCTGID: "merchandctgid",
    MERCHANDCTGNAME: "merchandctgname",
    BRANDCOMPID: "brandcompid",
    BRANDCOMPNAME: "brandcompname",
    UOMID: "uomid",
    UOMNAME: "uomname",
    CREATETIME: "createtime",
    LTTYPE: "ltype",
...
const SALES = {
  ...
  COLUMNS: {
    ...
    TOTNOOFBILLS: "totnoofbills",
    CASHGIFTCARD: "cashgiftcard",
    COUNTRET: "countret",
    CASHRET: "cashret",
    CREDITRET: "creditret",
    ORDERRET: "orderret",
...
const LOYALTY_APPLY_DETAILS = {
  NAME: "loyality_apply_details",
  COLUMNS: {
    ID: "id", 
    BILL_NO: "bill_no", 
    CUSTOMER_ID: "customer_id",
